        ...
        <div className={`grouped-section-box schedule-box ${isScheduleOpen ? 'open' : ''}`}>
          ...
          <div className={`collapsible-wrapper ${isScheduleOpen ? 'expanded' : 'collapsed'}`}>
            <div className="section-content">
              ...
              {/* Progress Slider - Shows only when In Progress */}
              {formData.status === 'In Progress' && (
                <div className="form-section range-slider-section mt-12">
                  <div className="slider-header">
                    <label>COMPLETION PROGRESS</label>
                    <span className="percentage-badge">{formData.progress || 0}%</span>
                  </div>
                  <input 
                    type="range" 
                    name="progress" 
